...
namespace RedRats.Editor.Attributes
{
    ...
    public class SortingLayerPropertyDrawer : PropertyDrawer
    {
        ...
        {
            MethodInfo methodInfo = typeof(EditorGUILayout).GetMethod(SortingLayerFieldMethodName, BindingFlags.Static | BindingFlags.NonPublic, null, new[] {typeof(GUIContent), typeof(SerializedProperty), typeof(GUIStyle), typeof(GUIStyle)}, null);
