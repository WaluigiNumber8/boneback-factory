...
namespace Rogium.ExternalStorage
{
    ...
    public class ExternalStorageOverseer
    {
        ...
        {
            string savePath = Path.Combine(packDirectoryPath, pack.PackInfo.Title + packExtension);
        ...
        public void Delete(string packTitle)
        {
            string removePath = Path.Combine(packDirectoryPath, packTitle + packExtension);
