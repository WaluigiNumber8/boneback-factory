...
namespace Rogium.Systems.Input
{
    ...
    ""controlSchemes"": [
        ...
        ~@RogiumInputActions()
        {
            Debug.Assert(!m_UI.enabled, "This will cause a leak and performance issues, RogiumInputActions.UI.Disable() has not been called.");
            Debug.Assert(!m_Player.enabled, "This will cause a leak and performance issues, RogiumInputActions.Player.Disable() has not been called.");
        }
