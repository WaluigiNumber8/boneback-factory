...
namespace Rogium.Editors.PropertyEditor.Builders
{
    ...
    public class PropertyEditorBuilderWeapon : PropertyEditorBuilderAnimationBase
    {
        ...
        protected override void BuildColumnImportant(Transform content)
        {
            ...
            b.BuildAssetField("", AssetType.Sprite, asset, animationBlock1Slot.GetTransform, a => asset.UpdateIcon(a), false, !currentPack.ContainsAnySprites, ThemeType.Green);
            
            animationBlock2Slot = b.CreateContentBlockColumn2(content, (asset.AnimationType != AnimationType.SpriteSwap));
            b.BuildAssetField("", AssetType.Sprite, asset, animationBlock2Slot.GetTransform, a => asset.UpdateIcon(a), false, !currentPack.ContainsAnySprites, ThemeType.Green);
            b.BuildAssetField("", AssetType.Sprite, asset, animationBlock2Slot.GetTransform, a => asset.UpdateIconAlt(a.Icon), false, !currentPack.ContainsAnySprites, ThemeType.Green);
        ...
        private void LoadProjectileSlots(int amount)
        {
            ...
            for (int i = 0; i < amount; i++)
            {
                ...
                b.BuildAssetField($"Projectile #{index+1}", AssetType.Projectile, p, projectileSlotsBlock.GetTransform, a => asset.UpdateProjectileIDsPosID(index, a.ID), false, !currentPack.ContainsAnyProjectiles);
