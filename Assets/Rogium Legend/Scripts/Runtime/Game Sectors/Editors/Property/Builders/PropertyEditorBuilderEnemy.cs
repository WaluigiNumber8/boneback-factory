...
namespace Rogium.Editors.PropertyEditor.Builders
{
    ...
    public class PropertyEditorBuilderEnemy : PropertyEditorBuilderAnimationBase
    {
        ...
        {
            IAsset initialIcon = currentPack.TryGetSprite(asset.AssociatedSpriteID, EditorDefaults.Instance.EnemyIcon);
        ...
        protected override void BuildColumnProperty(Transform content)
        {
            ...
            b.BuildSlider("Invincibility Time", 0f, EditorDefaults.Instance.EnemyInvincibilityTimeMax, asset.InvincibilityTime, content, f => asset.UpdateInvincibilityTime(f));
            b.BuildHeader("Knockback", content);
            b.BuildSlider("Self Force", -EditorDefaults.Instance.EnemyKnockbackForceMax, EditorDefaults.Instance.EnemyKnockbackForceMax, asset.KnockbackForceSelf, content, f => asset.UpdateKnockbackForceSelf(f));
            b.BuildSlider("Other Force", -EditorDefaults.Instance.EnemyKnockbackForceMax, EditorDefaults.Instance.EnemyKnockbackForceMax, asset.KnockbackForceOther, content, f => asset.UpdateKnockbackForceOther(f));
            ...
            b.BuildSlider("Next Rotation Time", 0.01f, EditorDefaults.Instance.EnemyNextStepTimeMax, asset.NextStepTime, aiRotateTowardsBlock.GetTransform, f => asset.UpdateNextStepTime(f));
            ...
            b.BuildSlider("Frame Duration", 1, EditorDefaults.Instance.EnemyFrameDurationMax, asset.FrameDuration, content, i => asset.UpdateFrameDuration((int)i));
        ...
        private void BuildWeaponSection(Transform content)
        {
            ...
            b.BuildSlider("Attack Delay", 0f, EditorDefaults.Instance.EnemyAttackDelayMax, asset.UseDelay, content, f => asset.UpdateUseDelay(f));
            b.BuildSlider("Attack Probability", 0, 100, (int)(asset.AttackProbability * 100), content, f => asset.UpdateAttackProbability(f * 0.01f));
            b.BuildSlider("Weapon Amount", 0, EditorDefaults.Instance.EnemyWeaponMaxCount, asset.WeaponIDs.Count, content, f => LoadWeaponSlots((int)f), !currentPack.ContainsAnyWeapons);
