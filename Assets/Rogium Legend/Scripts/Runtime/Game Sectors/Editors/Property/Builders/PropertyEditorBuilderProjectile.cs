...
namespace Rogium.Editors.PropertyEditor.Builders
{
    ...
    public class PropertyEditorBuilderProjectile : PropertyEditorBuilderAnimationBase
    {
        ...
        protected override void BuildColumnImportant(Transform content)
        {
            ...
            b.BuildAssetField("", AssetType.Sprite, asset, animationBlock1Slot.GetTransform, a => asset.UpdateIcon(a), false, !currentPack.ContainsAnySprites, ThemeType.Teal);
            
            animationBlock2Slot = b.CreateContentBlockColumn2(content, (asset.AnimationType != AnimationType.SpriteSwap));
            b.BuildAssetField("", AssetType.Sprite, asset, animationBlock2Slot.GetTransform, a => asset.UpdateIcon(a), false, !currentPack.ContainsAnySprites, ThemeType.Teal);
            b.BuildAssetField("", AssetType.Sprite, asset, animationBlock2Slot.GetTransform, a => asset.UpdateIconAlt(a.Icon), false, !currentPack.ContainsAnySprites, ThemeType.Teal);
