...
namespace Rogium.Editors.PropertyEditor.Builders
{
    ...
    public class PropertyEditorBuilderTile : PropertyEditorBuilderBase
    {
        ...
        {
            b.BuildAssetField("", AssetType.Sprite, asset, content, delegate(IAsset a) { asset.UpdateIcon(a);}, false, !PackEditorOverseer.Instance.CurrentPack.ContainsAnyTiles, ThemeType.Yellow);
