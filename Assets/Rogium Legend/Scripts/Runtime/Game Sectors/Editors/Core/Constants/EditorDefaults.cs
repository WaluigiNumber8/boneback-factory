...
namespace Rogium.Editors.Core.Defaults
{
    ...
    public class EditorDefaults : ScriptableObject
    {
        ...
        [SerializeField, Required, FoldoutGroup("Weapons")] private int weaponFrameDuration = 40;
        [SerializeField, Required, FoldoutGroup("Weapons")] private int weaponFrameDurationMax = 1200;
        ...
        [SerializeField, Required, FoldoutGroup("Weapons")] private WeaponUseType weaponUseType = WeaponUseType.PopUp;
        [SerializeField, Required, FoldoutGroup("Weapons")] private float weaponUseDuration = 0.2f;
        [SerializeField, Required, FoldoutGroup("Weapons")] private float weaponUseDurationMax = 20f;
        [SerializeField, Required, FoldoutGroup("Weapons")] private float weaponUseStartDelay;
        [SerializeField, Required, FoldoutGroup("Weapons")] private float weaponUseStartDelayMax = 20f;
        ...
        [SerializeField, Required, FoldoutGroup("Weapons")] private int weaponProjectileMaxCount = 12;
        ...
        [SerializeField, Required, FoldoutGroup("Weapons")] private float weaponProjectileSpawnDelay;
        [SerializeField, Required, FoldoutGroup("Weapons")] private float weaponProjectileSpawnDelayMax = 20f;
        ...
        [SerializeField, Required, FoldoutGroup("Projectiles")] private int projectileFrameDuration = 40;
        [SerializeField, Required, FoldoutGroup("Projectiles")] private int projectileFrameDurationMax = 1200;
        [SerializeField, Required, FoldoutGroup("Projectiles")] private int projectileBaseDamage = 1;
        [SerializeField, Required, FoldoutGroup("Projectiles")] private float projectileLifetime = 0.5f;
        [SerializeField, Required, FoldoutGroup("Projectiles")] private float projectileLifetimeMax = 120f;
        ...
        [SerializeField, Required, FoldoutGroup("Projectiles")] private float projectileAcceleration = 0.5f;
        [SerializeField, Required, FoldoutGroup("Projectiles")] private float projectileAccelerationMax = 1f;
        [SerializeField, Required, FoldoutGroup("Projectiles")] private float projectileBrakeForce = 0.01f;
        [SerializeField, Required, FoldoutGroup("Projectiles")] private float projectileBrakeForceMax = 2f;
        [SerializeField, Required, FoldoutGroup("Projectiles")] private PierceType projectilePierceType = PierceType.None;
        ...
        [SerializeField, Required, FoldoutGroup("Enemies")] private int enemyFrameDuration = 50;
        [SerializeField, Required, FoldoutGroup("Enemies")] private int enemyFrameDurationMax = 1200;
        ...
        [SerializeField, Required, FoldoutGroup("Enemies")] private float enemyAttackDelay = 2f;
        [SerializeField, Required, FoldoutGroup("Enemies")] private float enemyAttackDelayMax = 20f;
        ...
        [SerializeField, Required, FoldoutGroup("Enemies")] private int enemyWeaponMaxCount = 9;
        ...
        [SerializeField, Required, FoldoutGroup("Enemies")] private float enemyNextStepTime = 0.25f;
        [SerializeField, Required, FoldoutGroup("Enemies")] private float enemyNextStepTimeMax = 20f;
        ...
        [SerializeField, Required, FoldoutGroup("Rooms")] private int roomLightness = 255;
        ...
        [SerializeField, Required, FoldoutGroup("Tiles")] private TileType tileType = TileType.Tile;
        [SerializeField, Required, FoldoutGroup("Tiles")] private TileLayerType tileLayer = TileLayerType.Wall;
        [SerializeField, Required, FoldoutGroup("Tiles")] private TerrainType tileTerrainType = TerrainType.Tile;
        
        [SerializeField, Required, FoldoutGroup("Sounds")] private float soundPitchOffset = 0.05f;
