...
namespace Rogium.Editor.UI
{
    public class RogiumScreenSwitcher : OdinEditorWindow
    {
        ...
        [SerializeField, FoldoutGroup("Menu Objects", order:5), GUIColor(1f, 0.5f, 0.5f)] public GameObject menuBackground;
        [SerializeField, FoldoutGroup("Menu Objects"), GUIColor(1f, 0.5f, 0.5f)] public GameObject mainMenuUI;
        [SerializeField, FoldoutGroup("Menu Objects"), GUIColor(1f, 0.5f, 0.5f)] public GameObject optionsMenuUI;
        [SerializeField, FoldoutGroup("Menu Objects"), GUIColor(1f, 0.5f, 0.5f)] public GameObject changelogUI;
        [Space]
        [SerializeField, FoldoutGroup("Menu Objects"), GUIColor(1f, 0.65f, 0.4f)] public GameObject gameBackground;
        [SerializeField, FoldoutGroup("Menu Objects"), GUIColor(1f, 0.65f, 0.4f)] public GameObject campaignSelectionMenuUI;
        [SerializeField, FoldoutGroup("Menu Objects"), GUIColor(1f, 0.65f, 0.4f)] public GameObject campaignEditorUI;
        [Space]
