...
public class test_Selection_Picker_Menu
{
    ...
    public void Setup()
    {
        ...
        GameObject selectionPickerMenu = AssetDatabase.LoadAssetAtPath<GameObject>("Assets/Rogium Legend/Prefabs/UI/Menus/pref_Menu_SelectionPicker.prefab");
